...
export const TooltipWithLink: Story<AppComponent> = (args) => ({
  props: args,
  template:
...
export const TooltipWithPTag: Story<AppComponent> = (args) => ({
  props: args,
  template:
      `<rds-tooltip [tooltipTitle] = "tooltipTitle" [tooltipPosition] = "tooltipPosition">
      <p style="display: inline;">hello this paragarph</p>
      </rds-tooltip>
      `,
});
...
export const TooltipWithSvg: Story<AppComponent> = (args) => ({
  props: args,
  template:
      `<rds-tooltip [tooltipTitle] = "tooltipTitle" [tooltipPosition] = "tooltipPosition">
